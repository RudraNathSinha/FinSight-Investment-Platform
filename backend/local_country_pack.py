...
def _pack_dirs() -> List[str]:
    """Project country_packs folder (under part2_global_equity/data)."""
    here = os.path.dirname(os.path.abspath(__file__))
    root = os.path.abspath(os.path.join(here, ".."))
    candidates = [
        os.path.join(root, "part2_global_equity", "data", "country_packs"),
        os.path.join(root, "data", "country_packs"),
    ]
    out = []
